    ...
    for (uint32 i = 0; i < sSpellStore.GetNumRows(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
            case 38776: // Evergrove Druid Transform Crow
                ...
                break;
            case 55593: //Necrotic Aura
                spellInfo->DurationIndex = 1;
                break;
            case 28433:
                spellInfo->Effect[0] = SPELL_EFFECT_INSTAKILL;
                break;
        ...
        */
        ...
        case 42669:
        case 59706:
            spellInfo->AttributesEx2 |= SPELL_ATTR1_UNAFFECTED_BY_SCHOOL_IMMUNE;
            break;
        ...
        case 53030:
        case 59417:
            spellInfo->EffectApplyAuraName[0] = SPELL_AURA_PERIODIC_DAMAGE; // Fix Hadronox leach poison normal
            break;
        ...
        // Twilight Shift
        case 57874:
            spellInfo->EffectBasePoints[1] = 762; // DUNGEONCRAFT REBALANCED - Damage reduced by 25% 
            break;
        ...
        // Vortex (Malygos)
        case 56256:
            spellInfo->EffectBasePoints[1] = 1499; // DUNGEONCRAFT REBALANCED - Damage reduced by 25% 
            break;
