...
void Spell::EffectEnergize(SpellEffIndex effIndex)
{
    ...
    switch (m_spellInfo->Id)
    {
        ...
        case 24532:                                         // Burst of Energy
            ...
            level_multiplier = 4;
            break;
        //@TODO - Fix water shield refunding mana with spirit calculation. Note: damage = mana refunded; no idea why, no idea how that's calculated either.
        case 57961:
            break;
...
void Spell::EffectDuel(SpellEffIndex effIndex)
{
    ...
    if (casterAreaEntry && !(casterAreaEntry->flags & AREA_FLAG_ALLOW_DUELS) && casterAreaEntry->ID != 4564)
    {
    ...
    if (targetAreaEntry && !(targetAreaEntry->flags & AREA_FLAG_ALLOW_DUELS) && targetAreaEntry->ID != 4564)
    {
        SendCastResult(SPELL_FAILED_NO_DUELING);            // Dueling isn't allowed here
        return;
    }
