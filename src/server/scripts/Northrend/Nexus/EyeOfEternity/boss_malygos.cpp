...
#define SPELL_ARCANE_BREATH             RAID_MODE(SPELL_ARCANE_BREATH_N, SPELL_ARCANE_BREATH_H)
#define SPELL_ARCANE_STORM              RAID_MODE(SPELL_ARCANE_STORM_N, SPELL_ARCANE_STORM_H)
#define SPELL_PH3_SURGE_OF_POWER        RAID_MODE(SPELL_PH3_SURGE_OF_POWER_N, SPELL_PH3_SURGE_OF_POWER_H)
...
#define MAX_NEXUS_LORDS                 DUNGEON_MODE(1, 2)
#define MAX_SCIONS_OF_ETERNITY          DUNGEON_MODE(3, 5)
