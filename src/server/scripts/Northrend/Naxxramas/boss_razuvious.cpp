...
public:
    ...
    struct boss_razuviousAI : public BossAI
    {
        ...
        void SpawnHelpers()
        {
            me->SummonCreature(NPC_DEATH_KNIGHT_UNDERSTUDY, 2782.45f, -3088.03f, 267.685f, 0.75f, TEMPSUMMON_CORPSE_DESPAWN);
            me->SummonCreature(NPC_DEATH_KNIGHT_UNDERSTUDY, 2778.56f, -3113.74f, 267.685f, 5.28f, TEMPSUMMON_CORPSE_DESPAWN);
            //if (Is25ManRaid())
            //{
            //    me->SummonCreature(NPC_DEATH_KNIGHT_UNDERSTUDY, 2762.23f, -3085.07f, 267.685f, 1.95f, TEMPSUMMON_CORPSE_DESPAWN);
            //    me->SummonCreature(NPC_DEATH_KNIGHT_UNDERSTUDY, 2758.24f, -3110.97f, 267.685f, 3.94f, TEMPSUMMON_CORPSE_DESPAWN);
            //}
        }
...
public:
    ...
    struct boss_razuvious_minionAI : public ScriptedAI
    {
        ...
        void OnCharmed(bool apply) override
        {
            ...
            if (apply)
            {
                ...
                if (Is25ManRaid())
                    if (_charmer && _charmer == me->GetCharmerGUID())
                    {
                        me->RemoveCharmedBy(ObjectAccessor::GetUnit(*me, _charmer));
                        me->RemoveCharmAuras();
                        me->DeleteCharmInfo();
                        return;
                    }
    ...
    {
        return new boss_razuvious_minionAI(creature);
    }
};
