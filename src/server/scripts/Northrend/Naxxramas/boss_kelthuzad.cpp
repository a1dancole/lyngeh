...
public:
    ...
    struct boss_kelthuzadAI : public BossAI
    {
        ...
        void EnterCombat(Unit * who) override
        {
            ...
            events.ScheduleEvent(EVENT_SUMMON_SOUL_WEAVER, 15000);
        ...
        {
            if (cr->GetEntry() == NPC_UNSTOPPABLE_ABOMINATION)
            {
                cr->SetMaxHealth(RAID_MODE(105600, 135600));
            }
            ...
            switch (events.GetEvent())
            {
                ...
                case EVENT_SPELL_FROST_BLAST:
                {
                    ...
                    for (; i != me->getThreatManager().getThreatList().end(); ++i)
                        ...
                        {
                            if ((*i)->getTarget()->ToPlayer()->HasHealSpec() || (*i)->getTarget()->ToPlayer()->HasTankSpec())
                                continue;
                    ...
                    if (!targets.empty())
                    {
                        ...
                        me->CastSpell(*itr, SPELL_FROST_BLAST, false);
                    }
